...
Global search now tokenizes natural addresses, ignores street-type words, municipality/province text, postal codes, accents, punctuation, and updates automatically while typing. Verified that `5281 Chambord St. Montreal, QC H2J 3N4` returns the correct `5279–5281 rue Chambord` site among matching address records.

Verified exact natural-language address query returns one result: `5279–5281 rue Chambord (MTL)`.
